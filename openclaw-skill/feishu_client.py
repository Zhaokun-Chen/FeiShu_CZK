...
class LarkCLIClient:
    ...
    def _run_json(self, args: list[str]) -> dict[str, Any]:
        ...
        try:
            ...
            raise LarkCLIError("lark-cli did not return valid JSON output") from exc
    ...
    def search_documents(self, query: str, page_size: int = 10) -> list[SearchResult]:
        if self.http_mode:
            try:
                ...
                if "404" in message or "not support" in message or "not found" in message:
    ...
    def _http_import_markdown(self, file_name: str, markdown: str) -> dict[str, Any]:
        ...
        create_resp = self._http_request(
            ...
            "/drive/v1/files",
            body={
                "name": _sanitize_import_name(file_name),
                "type": "docx",
            },
        )
        document_id = create_resp.get("token")
